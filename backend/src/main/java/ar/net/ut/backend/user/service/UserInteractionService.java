...
public class UserInteractionService {
    ...
    public UserInteractionDTO createInteraction(UserInteractionCreateDTO dto) {
        ...
        if (interactionRepository.existsByUserIdAndTypeAndResourceTypeAndResourceId(
    ...
    public List<UserInteractionDTO> getMyInteractions() {
        User currentUser = userService.getCurrentUser();
        return interactionMapper.toDTOList(interactionRepository.findAllByUserId(currentUser.getId()));
    }
    ...
    public void deleteInteraction(Long id) {
        ...
        UserInteraction interaction = interactionRepository.findByIdAndUserId(id, currentUser.getId())
