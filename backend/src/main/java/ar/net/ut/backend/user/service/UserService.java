...
public class UserService {
    ...
    private static final Set<String> ALLOWED_PICTURE_FORMATS = Set.of("png", "jpg", "jpeg");
    private static final long MAX_PICTURE_SIZE = 10_485_760; // In bytes
    ...
    public UserDTO createUser(Long inviterReferralId, UserCreateDTO dto) {
        ...
        if (token == null || token.getClaim("type").as(TokenService.TokenType.class) != TokenService.TokenType.REGISTRATION) {
            throw new TokenException("Invalid or expired registration token", HttpStatus.FORBIDDEN);
        }
    ...
    public UserProfilePictureResponseDTO updateUserProfilePicture(MultipartFile file) {
        ...
        try {
            ...
            throw new InternalException("An internal error ocurred while trying to resize an image");
        }
